...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button verifyOTPBtn, idBtnGetOtp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idBtnGetOtp = findViewById(R.id.idBtnGetOtp);

        idBtnGetOtp.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Intent i = new Intent(LoginActivity.this, DrawerNavigation.class);
                            startActivity(i);
                            finish();
                        } else {
